    ...
    return (
      ...
      */}
            <div className="container-fluid">
                <div className="left">
                    <img src={left} style={{ height: "470px", width: "390px", borderRadius: "20%" }} alt="dia" />
                </div>
                <div className="right" >
                    <img src={right} style={{ height: "470px", width: "390px", borderRadius: "20%" }} alt="dia" />
                </div>
            ...
            <div class="container-fluid" id="chose" style={{
            ...
            <br />
            <div class="social">
                <div class=" container  shadow p-3 mb-5 bg-white rounded"> <center><h1><strong>OUR </strong>STORY</h1> </center>
